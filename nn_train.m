...
for i=1:numepochs
    ...
    [temp, tempY] = xyimgIdx2data(params, params.trainXYimg,...
        params.imgIdx(currentPartIdx), params.imgDataIdx(currentPartIdx,:));
...
function [partIdx, cacheX, cacheY, batchX, batchY, Idx] = getNextBatchX(cacheX, cacheY, partIdx, params, opts, Idx)
    if size(cacheX,1)<=opts.batchsize
        ...
        for i=1:param.cacheImageNum
            ...
            partIdx = partIdx+1;
            [nextimgX, nextimgY] = xyimgIdx2data(params.data_per_img, params.WindowSize, params.StrideSize, params.trainXYimg,...
